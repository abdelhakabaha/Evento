  ...
  <div class="overflow-auto lg:overflow-visible">
    <div class="flex lg:justify-between border-b-2 border-fuchsia-900 pb-1">
      ...
      <div class="text-center flex-auto">
        ...
        {{-- <button type="button" class="ml-20 px-5 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:bg-blue-600">
        Ajouter
      </button> --}}
      <a href="{{ route('organisateur.create') }}"  class="ml-20 px-5 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:bg-blue-600">Ajouter</a>
