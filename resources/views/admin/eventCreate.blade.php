...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
  ...
  <div class="my-6">
              <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                  <div>
                      <h1 class="text-3xl font-extrabold">Let's Create <br> new Event</h1>
                      <p class="text-sm text-gray-400 mt-3">add new Event</p>
                     
                
                  </div>

                
                  <form action="{{ route('event.store') }}" method="post" class="ml-auo space-y-4"
                  ...
                  >
                    ...
                    @csrf
                      ...
                      <button 
                          class="text-white bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Create</button>
                  </form>
              </div>
          </div>
