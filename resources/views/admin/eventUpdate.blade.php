        ...
        <ul class="mb-4 flex flex-col gap-1">
          <li>
            <a aria-current="page" class="active" href="#">
              <a class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg bg-gradient-to-tr from-blue-600 to-blue-400 text-white shadow-md shadow-blue-500/20 hover:shadow-lg hover:shadow-blue-500/40 active:opacity-[0.85] w-full flex items-center gap-4 px-4 capitalize" href="/dashboard">
...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
  ...
  <div class="my-6">
              <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                  <div>
                      <h1 class="text-3xl font-extrabold">Let's Update <br> Event</h1>
                      <p class="text-sm text-gray-400 mt-3">update event</p>
                     
                
                  </div>

                
                  <form action="{{ route('event.update' , $event) }}" method="POST" class="ml-auo space-y-4"
                  ...
                  >
                    ...
                    @method('PUT')
                      ...
                      <input type='text' name ="title" placeholder='title'
                        ...
                        @error('title')
                        <p class="text-red-500 p-0 ml-3">{{ $message }}</p>
                        @enderror
                      ...
                      <input type='file' name ="image" placeholder='image'
                          class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff]  object-cover w-8 h-8 rounded-full" />
                        @error('image')
                        <p class="text-red-500 p-0 ml-3">{{ $message }}</p>
                        @enderror
                    
                      <input type='number' name ="nbPlace" placeholder='nbPlace'
                          class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff]" />
                        @error('nbPlace')
                        <p class="text-red-500 p-0 ml-3">{{ $message }}</p>
                        @enderror
                      ...
                      <select name="categorie_id" class="w-full border-2 h-10" >
                      ...
                      <button 
                          class="text-white bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Update</button>
                  </form>
              </div>
          </div>
