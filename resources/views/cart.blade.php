...
<div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4">
    <img class="w-full h-56 object-cover object-center" src="storage/{{$event->image}}" alt="avatar">
    ...
    <div class="py-4 px-6">
        <h1 class="text-2xl font-semibold text-gray-800">{{$event->titre}}</h1>
        ...
        <div class="flex items-center mt-4 text-gray-700">
            ...
            <h1 class="px-2 text-sm">{{ $event->user_id }}</h1>
        </div>
        <div class="flex items-center mt-4 text-gray-700">
            <svg class="h-6 w-6 fill-current" viewBox="0 0 512 512">
        ...
        <div class="flex items-center mt-4 text-gray-700">
            ...
            <a href="/confirme"><button class=" bg-blue-600 text-gray-200 px-2 py-2 rounded-md ">Réservation</button></a>
        </div>
    </div>
